...
class plane_part_stewart_client(object):
    def __init__(self):
        self.goalsub = rospy.Subscriber('/execute_trajectory/goal',moveit_msgs.msg.ExecuteTrajectoryActionGoal,self.traj_cb)

        # Creates the SimpleActionClient, passing the type of the action
        # (FibonacciAction) to the constructor.
        self.client = actionlib.SimpleActionClient('stewart_driver', moveit_msgs.msg.ExecuteTrajectoryAction)
