...
class calibrate_stewart(object):
    ...
    def initializeStandardStewart(self, r1, a1, z1, r2, a2, z2):
        ...
        self.bottomJoints = np.array(
            [[r1 * math.cos(i), r1 * math.sin(i), z1] for i in bottomAngleList]
        )
        ...
        self.stewartKinmatics = stewartKin.stewartKin(
            self.bottomJoints, self.platformJoints
        )
