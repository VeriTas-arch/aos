...
class calibrate_stewart(object):
    def __init__(self, saved_file_name):
        ...
        self.initializeStandardStewart(bottomRadius, bottomNeiborAngle,bottomZoffset,platformRadius,platformNeiborAngle,platformZoffset)
    ...
    def initializeStandardStewart(self, r1, a1, z1, r2, a2, z2):
        ...
        self.platformJoints = np.array([[r2*math.cos(i),r2*math.sin(i),z2] for i in platformAngleList])
    ...
    def execute_calibration(self):
        ...
        output={"calibration":{}}
        output['calibration']['bottom_transform'] = tqBottom #[transBottom.transform.translation.x, transBottom.transform.translation.y, transBottom.transform.translation.z,
                                      #transBottom.transform.rotation.x, transBottom.transform.rotation.y, transBottom.transform.rotation.z, transBottom.transform.rotation.w]
        output['calibration']['platform_transform'] = tqPlatform #[transPlatform.transform.translation.x, transPlatform.transform.translation.y, transPlatform.transform.translation.z,
                                      #transPlatform.transform.rotation.x, transPlatform.transform.rotation.y, transPlatform.transform.rotation.z, transPlatform.transform.rotation.w]
